...
`animatrixr` is a toy package I created to support a [blog post](https://www.bryanshalloway.com/2020/02/24/animatrixr-visualizing-matrix-transformations-pt-2/) I wrote on exploring animating matrix transformations using `gganimate`. It allows you to stitch together and then animate matrix transformations. For example:
